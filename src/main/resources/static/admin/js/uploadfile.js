...
!function (e) {
    ...
    e.fn.fileinputLocales = {}, e.fn.fileinputThemes = {}, e.fn.fileinputBsVersion || (e.fn.fileinputBsVersion = window.Alert && window.Alert.VERSION || window.bootstrap && window.bootstrap.Alert && bootstrap.Alert.VERSION || "3.x.x"), String.prototype.setTokens = function (e) {
        ...
        dataURI2Blob: function (e) {
            ...
            return n = e.split(",")[0].split(":")[1].split(";")[0], d ? new Blob([t.hasArrayBufferViewSupport() ? r : a], {type: n}) : ((o = new l).append(a), o.getBlob(n))
        },
        arrayBuffer2String: function (e) {
            if (window.TextDecoder) return new TextDecoder("utf-8").decode(e);
            var t, i, a, r, s = Array.prototype.slice.apply(new Uint8Array(e)), n = "", o = 0;
        ...
        cspBuffer: {
            CSP_ATTRIB: "data-csp-01928735", domElementsStyles: {}, stash: function (i) {
                var a = this, r = e.parseHTML("<div>" + i + "</div>"), s = e(r);
                return s.find("[style]").each(function (i, r) {
                    var s = e(r), n = s[0].style, o = t.uniqId(), l = {};
                ...
                e(t).find("[" + i.CSP_ATTRIB + "]").each(function (t, a) {
                    var r = e(a), s = r.attr(i.CSP_ATTRIB), n = i.domElementsStyles[s];
        ...
        whenAll: function (i) {
            var a, r, s, n, o, l, d = [].slice, c = 1 === arguments.length && t.isArray(i) ? i : d.call(arguments),
                u = e.Deferred(), p = 0, f = c.length, h = f;
        ...
        constructor: i, _cleanup: function () {
            ...
            var i = this.taskManager = {
                pool: {}, addPool: function (e) {
                    ...
                    r.id = a, r.cancelled = !1, r.cancelledDeferrer = e.Deferred(), r.tasks = {}, r.addTask = function (e, t) {
                        ...
                        var a, s, n, o = 0, l = !1, d = t.getObjectKeys(r.tasks).map(function (e) {
                            return r.tasks[e]
                        }), c = [], u = e.Deferred();
            ...
            var r, s, n, o, l = this, d = l.$element;
            ...
            i.uploadStartTime = t.now(), i.fileManager = {
                ...
                getUploadStats: function (e, a, r) {
                    var s, n = i.fileManager, o = e ? n.stats[e] && n.stats[e].started || t.now() : i.uploadStartTime,
                        l = (t.now() - o) / 1e3, d = Math.ceil(l ? a / l : 0), c = r - a,
            ...
            var i, a = this, r = a.resumableUploadOptions, s = t.logMessages, n = a.fileManager;
            if (a.enableResumableUpload) if (!1 !== r.fallback && "function" != typeof r.fallback && (r.fallback = function (e) {
                ...
                if (r.chunkSize = parseFloat(r.chunkSize), r.chunkSize <= 0 || isNaN(r.chunkSize)) return a._log(s.invalidChunkSize, {chunkSize: r.chunkSize}), void (a.enableResumableUpload = !1);
                (i = a.resumableManager = {
                    init: function (e, t, s) {
                        ...
                        var s, o, l = i.id, d = i.$thumb, c = i.$progress, u = d && d.length,
                        ...
                        var e, t, s = a.taskManager, n = i.chunkCount;
                        ...
                        r.testUrl ? (s = new FormData, o = n.stack[f], a._setUploadData(s, {
                            ...
                            var d = a.uploadParamNames.chunksUploaded || "chunksUploaded", c = [f, n, i, p];
                        ...
                        r.addTask(r.size() + 1, function (e) {
                            ...
                            t = r[0], i.chunksProcessed[i.id] && i.chunksProcessed[i.id][t] ? a._log(s.chunkQueueError, {index: t}) : i.sendAjax(t, r[1], e)
                        }), i.stack.push([e, t])
                    }, sendAjax: function (e, o, l) {
                        var d, c = i.chunkSize, u = i.id, p = i.file, f = i.$thumb, h = t.logMessages, m = i.$btnDelete,
                            g = function (e, t) {
                                t && (e = e.setTokens(t)), e = h.resumableRequestError.setTokens({msg: e}), a._log(e), l.reject(e)
                            };
                        if (!i.chunksProcessed[u] || !i.chunksProcessed[u][e]) {
                            if (o > r.maxRetries) return g(h.resumableMaxRetriesReached, {n: r.maxRetries}), void i.setProcessed("error");
                            var v, w, b, _, C, x,
                                y = p[p.slice ? "slice" : p.mozSlice ? "mozSlice" : p.webkitSlice ? "webkitSlice" : "slice"](c * e, c * (e + 1));
                            v = new FormData, d = n.stack[u], a._setUploadData(v, {
                                ...
                                if (a._isAborted()) g(h.resumableAborting); else {
                                    w = a._getOutData(v, c, t);
                                    var p = a.uploadParamNames.chunkIndex || "chunkIndex", f = [u, e, o, n, i, w];
                                ...
                                a._isAborted() ? g(h.resumableAborting) : (w = a._getOutData(v, t), i.setAjaxError(t, r, s), a._raise("filechunkajaxerror", [u, e, o, n, i, w]), i.pushAjax(e, o + 1), g(h.resumableRetryError, {n: o - 1}))
                            }, x = function () {
            ...
            var i, a, r, s, n, o, l, d, c, u, p, f, h, m, g, v, w, b, _, C = this, x = function (e, i) {
            ...
            var i, a = this, r = a.previewMarkupTags, s = r.tagAfter;
            ...
            i.previewCache = {
                data: {}, init: function () {
                    ...
                    var r, s, n, o, l, d, c, u = t.INIT_FLAG + e, p = i.previewCache.data, f = p.config[e],
                        h = p.content[e], m = t.ifSet("previewAsData", f, i.initialPreviewAsData),
                        ...
                        v = function (e, a, r, s, n, o, l, d) {
                            var c = " file-preview-initial " + t.SORT_CSS + (l ? " " + l : ""),
                                u = i.previewInitId + "-" + o, p = f && f.fileId || u;
                            return i._generatePreviewTemplate(e, a, r, s, u, p, !1, null, c, n, o, d, g, f && f.zoomData || a)
                        };
                    return h && h.length ? (a = void 0 === a || a, n = t.ifSet("type", f, i.initialPreviewFileType || "generic"), l = t.ifSet("filename", f, t.ifSet("caption", f)), d = t.ifSet("filetype", f, n), o = i.previewCache.footer(e, a, f && f.size || null), c = t.ifSet("frameClass", f), r = m ? v(n, h, l, d, o, u, c) : v("generic", h, l, d, o, u, c, n).setTokens({content: p.content[e]}), p.tags.length && p.tags[e] && (r = t.replaceTags(r, p.tags[e])), t.isEmpty(f) || t.isEmpty(f.frameAttr) || ((s = t.createElement(r)).find(".file-preview-initial").attr(f.frameAttr), r = s.html(), s.remove()), r) : ""
                }, clean: function (e) {
                    ...
                    var r = i.previewCache.count(), s = i.reversePreviewOrder;
                    if (r) {
                    ...
                    var n, o = s.config[e], l = t.ifSet("caption", o), d = t.ifSet("width", o, "auto"),
                        c = t.ifSet("url", o, !1), u = t.ifSet("key", o, null), p = t.ifSet("fileId", o, null),
                        f = i.fileActionSettings, h = i.initialPreviewShowDelete || !1,
                        m = i.initialPreviewDownloadUrl ? i.initialPreviewDownloadUrl + "?key=" + u + (p ? "&fileId=" + p : "") : "",
                        g = o.downloadUrl || m, v = o.filename || o.caption || "", w = !!g,
                        b = t.ifSet("showRemove", o, h), _ = t.ifSet("showDownload", o, t.ifSet("showDownload", f, w)),
                        C = t.ifSet("showZoom", o, t.ifSet("showZoom", f, !0)),
                        x = t.ifSet("showDrag", o, t.ifSet("showDrag", f, !0)), y = !1 === c && a;
            ...
            var t = this.$errorContainer, i = this.resumableUploadOptions.retainErrorHistory;
            ...
            var a = this.$errorContainer, r = i || "fileuploaderror", s = t && t.fileId || "",
            ...
            for (s = 0; s < n.length; s++) if (r = n[s], a = (0, this.fileTypeSettings[r])(e, i) ? r : "", !t.isEmpty(a)) return a;
            return "other"
            ...
            var i = this._getPreviewIcon(t), a = e;
            ...
            var i = this, a = i.$element, r = i.$form, s = i.$container;
            ...
            var a = i.originalEvent.dataTransfer, r = e.inArray("Files", a.types) > -1;
            ...
            var i, a = this, r = (a.$element, e.originalEvent.dataTransfer), s = r.files, n = r.items,
            ...
            var i, a, r, s, n = this, o = n.$preview, l = "." + t.SORT_CSS, d = e("body"), c = e("html"),
                u = n.reversePreviewOrder, p = window.Sortable;
            p && 0 !== o.find(l).length && (a = d.length ? d : c.length ? c : n.$container, i = {
                ...
                onEnd: s,
                onSort: function (i) {
                    var a = i.oldIndex, r = i.newIndex, s = 0, o = n.initialPreviewConfig.length, l = o > 0 && r >= o,
                        d = e(i.item);
            ...
            (t.autoOrientImageInitial || a) && t.getFrames(".file-preview-initial").each(function () {
                var r, s, n, o = e(this), l = t.initialPreviewConfig[i];
            ...
            var i = this.previewZoomButtonIcons[e], a = this.previewZoomButtonClasses[e],
                r = ' title="' + (this.previewZoomButtonTitles[e] || "") + '" ', s = t.isBs(5) ? "bs-" : "",
            ...
            a.on(e + ".bs.modal", function (r) {
                if ("bs.modal" === r.namespace) {
                    var s = a.find(".btn-fullscreen"), n = a.find(".btn-borderless");
            ...
            var i, a = this, r = a._getLayoutTemplate("modalMain"), s = "#" + t.MODAL_ID;
            ...
            var t, i, a = this.$modal.data("previewId") || "", r = this.getFrames().toArray(), s = r.length,
                n = this.$modal.find(".btn-kv-prev"), o = this.$modal.find(".btn-kv-next");
            ...
            var t = this.$modal, i = t.find(".modal-header:visible"), a = t.find(".modal-footer:visible"),
                r = t.find(".kv-zoom-body"), s = e(window).height();
            ...
            var i = this.$modal, a = i.find(".btn-kv-fullscreen"), r = i.find(".btn-kv-borderless");
            ...
            var r, s, n, o, l, d, c, u, p, f, h, m, g = this, v = i.attr("id"), w = g._getZoom(v), b = g.$modal,
                _ = b.find(".btn-kv-fullscreen"), C = b.find(".btn-kv-borderless"), x = b.find(".btn-kv-toggleheader"),
                y = i.data("zoom");
            y && (y = decodeURIComponent(y), m = w.html().replace(t.ZOOM_VAR, "").setTokens({zoomData: y}), w.html(m), i.data("zoom", ""), w.attr("data-zoom", y)), s = w.attr("data-template") || "generic", n = (r = w.find(".kv-file-content")).length ? '<span class="kv-spacer"></span>\n' + r.html() : "", f = i.data("caption") || g.msgZoomModalHeading, h = i.data("size") || "", u = i.data("description") || "", b.find(".kv-zoom-caption").attr("title", f).html(f), b.find(".kv-zoom-size").html(h), p = b.find(".kv-zoom-description").hide(), u && (g.showDescriptionClose && (u = g._getLayoutTemplate("descriptionClose").setTokens({closeIcon: g.previewZoomButtonIcons.close}) + "</button>" + u), p.show().html(u), g.showDescriptionClose && g._handler(b.find(".kv-desc-hide"), "click", function () {
                ...
                var i, a, r = t.which || t.keyCode, s = g.processDelay + 1, n = e(this).find(".btn-kv-prev"),
                    o = e(this).find(".btn-kv-next"), l = e(this).data("previewId");
                [i, a] = g.rtl ? [39, 37] : [37, 39], e.each({prev: [n, i], next: [o, a]}, function (e, t) {
                    var i = t[0], a = t[1];
            ...
            var i = this.$modal;
            e && e.length && (t.initModal(i), t.setHtml(i, this._getModalContent()), this._setZoomContent(e), i.data({backdrop: !1}), i.modal("show"), this._initZoomButtons())
            ...
            var a, r, s, n, o = this.$modal.find(".kv-zoom-actions .btn-kv-" + t), l = this.getFrames().toArray(),
                d = [], c = l.length;
            if (this.reversePreviewOrder && (t = "prev" === t ? "next" : "prev"), !o.attr("disabled")) {
                ...
                for (c = d.length, r = 0; r < c; r++) if (e(d[r]).attr("id") === i) {
                    n = "prev" === t ? r - 1 : r + 1;
                    break
                }
            ...
            var i, a, r, s = this.showUploadedThumbs, n = !this.removeFromPreviewOnError,
            ...
            var i = this.previewTemplates, a = i[e] || i.other;
            ...
            var a = this, r = a.fileManager, s = function (e) {
                var s = 0, n = e.total, o = e.loaded || e.position, l = r.getUploadStats(i, o, n);
            ...
            var a, r = this._ajaxSettings, s = this.mergeAjaxCallbacks;
            ...
            var s, n, o, l, d, c, u, p, f, h, m, g, v, w = this, b = w.fileManager, _ = b.count(), C = new FormData,
            ...
            }, w._setFileData(C, P.file, F, a), w._setUploadData(C, {fileId: a}), w._ajaxSubmit(p, h, m, g, C, a, i)))
            ...
            var i, a, r, s, n, o, l = this, d = l.fileManager, c = d.total(),
                u = c > 0 || !e.isEmptyObject(l.uploadExtraData), p = new FormData, f = l.ajaxOperations.uploadBatch;
            if (0 !== c && u && !l._abort({})) {
                o = function () {
                    ...
                    var s = l._getOutData(p, r, i), d = 0, c = l._getThumbs(":not(.file-preview-success)"),
            ...
            var e, i, a, r, s, n = this, o = {}, l = new FormData, d = n.ajaxOperations.uploadExtra;
            e = function (e) {
                n.lock();
            ...
            i.showPreview && (i._initZoomButton(), i.getFrames(" .kv-file-remove").each(function () {
                var a, r = e(this), s = r.closest(t.FRAMES), n = s.attr("id"), o = s.attr("data-fileindex");
                i.fileManager;
            ...
            var i = this, a = i.$preview, r = i.deleteExtraData || {}, s = t.FRAMES + " .kv-file-remove",
                n = i.fileActionSettings, o = n.removeClass, l = n.removeErrorClass, d = function () {
            ...
            i._initZoomButton(), a.find(s).each(function () {
                var a, s, n, c, u = e(this), p = u.data("url") || i.deleteUrl, f = u.data("key"),
                    h = i.ajaxOperations.deleteThumb;
                if (!t.isEmpty(p) && void 0 !== f) {
                    "function" == typeof p && (p = p());
                    var m, g, v, w, b, _ = u.closest(t.FRAMES), C = i.previewCache.data, x = _.attr("data-fileindex");
            ...
            var a, r, s = parseFloat(t), n = this.fileSizeGetter;
            ...
            var g, v, w = this, b = w.slug(r), _ = "", C = "",
                x = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth, y = b,
                T = b, P = "type-default", k = u || w._renderFileFooter(i, b, d, "auto", l), F = w.preferIconicPreview,
                S = w.preferIconicZoomPreview, E = F ? "other" : i;
            return (g = x < 400 ? w.previewSettingsSmall[E] || w.defaults.previewSettingsSmall[E] : w.previewSettings[E] || w.defaults.previewSettings[E]) && e.each(g, function (e, t) {
                ...
                var g, v = d ? "zoom-" + n : n, _ = w._getPreviewTemplate(a), x = (c || "") + " " + u;
            ...
            }, p = p || n.slice(n.lastIndexOf("-") + 1), w.fileActionSettings.showZoom && (_ = v(S ? "other" : i, a, !0, "kv-zoom-thumb", m)), _ = "\n" + w._getLayoutTemplate("zoomCache").replace("{zoomContent}", _), "function" == typeof w.sanitizeZoomCache && (_ = w.sanitizeZoomCache(_)), v(F ? "other" : i, a, !1, "kv-preview-thumb", m).setTokens({zoomCache: _})
            ...
            var a = this.$preview;
            if (this.showPreview) {
                var r, s = t.getFileName(e), n = e ? e.type : "", o = e.size || 0, l = this._getFileName(e, ""),
                    d = !0 === i && !this.isAjaxUpload, c = t.createObjectURL(e), u = this.fileManager.getId(e),
            ...
            if (this.showPreview) {
                var n, o = t.getFileName(i), l = s.type, d = s.name, c = this._parseFileType(l, o), u = this.$preview,
                    p = i.size || 0, f = "image" === c ? a.target.result : r, h = this.fileManager.getId(i),
            ...
            var e, i, a, r, s, n = this.previewCache.data, o = this.previewCache.count(!0);
            if (0 !== o) for (var l = 0; l < o; l++) e = n.config[l], s = this.previewInitId + "-" + t.INIT_FLAG + l, i = t.ifSet("caption", e, t.ifSet("filename", e)), a = t.ifSet("size", e), r = t.ifSet("description", e), this._setThumbAttr(s, i, a, r)
            ...
            if (this.showPreview) {
                var a = "indicator" + i, r = a + "Title", s = "file-preview-" + i.toLowerCase(),
            ...
            if ((i = i || this.$progress).length) {
                var s, n = Math.min(e, 100), o = this.progressUploadThreshold,
                ...
                })).setTokens({stats: r}), t.setHtml(i, s), a && t.setHtml(i.find('[role="progressbar"]'), a))
            }
        }, _hasFiles: function () {
            ...
            var i, a;
            return this.showUploadStats && e && e.bitrate ? (a = this._getLayoutTemplate("stats"), i = e.elapsed && e.bps ? this.msgPendingTime.setTokens({time: t.getElapsed(Math.ceil(e.pendingBytes / e.bps))}) : this.msgCalculatingTime, a.setTokens({
                uploadSpeed: e.bitrate,
                pendingTime: i
            })) : ""
        }, _setResumableProgress: function (e, t, i) {
            var a = this.resumableManager, r = i ? a : this, s = i ? i.find(".file-thumb-progress") : null;
            ...
            if (this.showPreview || s && s.length) {
                var n, o = this.fileManager, l = this.resumableManager, d = o.getThumb(i), c = 0, u = o.getTotalSize(),
                    p = e.extend(!0, {}, r);
                if (this.enableResumableUpload) {
                    var f, h = r.loaded, m = l.getUploadedSize(), g = l.file.size;
            ...
            var i = e.find(".kv-file-upload"), a = this.fileActionSettings, r = a.uploadIcon, s = a.uploadTitle;
            ...
            var n, o, l, d = this, c = !i || !i.length, u = !a || !a.length, p = !1,
            ...
            c && u || (l = "load.fileinputimageorient", f ? (i = a, a = null, i.css(d.previewSettings.image), o = e(document.createElement("div")).appendTo(s.find(".kv-file-content")), n = e(document.createElement("span")).insertBefore(i), i.css("visibility", "hidden").removeClass("file-zoom-detail").appendTo(o)) : p = !i.is(":visible"), i.off(l).on(l, function () {
                ...
                var m = Math.atan(u / c), g = Math.sqrt(Math.pow(c, 2) + Math.pow(u, 2)),
                    v = g ? c / Math.cos(Math.PI / 2 + m) / g : 1, w = " scale(" + Math.abs(v) + ")";
            ...
            var c, u, p = null, f = this.autoOrientImage;
            ...
            var o, l, d, c = this, u = c.$preview, p = c._getFrame(e), f = p.attr("data-fileindex"), h = p.find("img");
            ...
            var t, i = this, a = {val: 0}, r = i.fileManager.getImageCount(), s = i.resizeIfSizeMoreThan;
            ...
            var n, o, l, d, c, u, p, f, h, m = this, g = e(a.img)[0], v = g.naturalWidth, w = g.naturalHeight, b = 1,
                _ = m.maxImageWidth || v, C = m.maxImageHeight || w, x = !(!v || !w), y = m.imageCanvas,
                T = m.imageCanvasContext, P = a.typ, k = a.pid, F = a.ind, S = a.thumb, E = a.exifObj;
            if (c = function (e, t, i) {
            ...
            if (this.$caption.length) {
                if (this.$captionContainer.removeClass("icon-visible"), a) r = e("<div>" + this.msgValidationError + "</div>").text(), (o = this.fileManager.count()) ? (d = this.fileManager.getFirstFile(), l = 1 === o && d ? d.nameFmt : this._getMsgSelected(o)) : l = this._getMsgSelected(this.msgNo), s = t.isEmpty(i) ? l : i, n = '<span class="' + this.msgValidationErrorClass + '">' + this.msgValidationErrorIcon + "</span>"; else {
            ...
            var i = this._getLayoutTemplate("btnDefault"), a = this[e + "Class"], r = this[e + "Title"],
                s = this[e + "Icon"], n = this[e + "Label"], o = this.isDisabled ? " disabled" : "", l = "button";
            switch (e) {
                case"remove":
            ...
            var n, o, l = this.fileActionSettings, d = l.showRemove, c = l.showDrag, u = l.showUpload, p = l.showZoom,
                f = this._getLayoutTemplate("footer"), h = this._getLayoutTemplate("indicator"),
                m = s ? l.indicatorError : l.indicatorNew, g = s ? l.indicatorErrorTitle : l.indicatorNewTitle,
            ...
            var p, f = !1 === o ? "" : ' data-url="' + o + '"', h = "", m = "",
                g = !1 === l ? "" : ' data-key="' + l + '"', v = "", w = "", b = "",
                _ = this._getLayoutTemplate("actions"), C = this.fileActionSettings,
            ...
            if (e(document.body).off("focusin.fileinput focusout.fileinput"), !a.changeTriggered) {
                a._setLoading("show");
                var r, s, n, o, l = a.$element, d = arguments.length > 1, c = a.isAjaxUpload,
                    u = d ? arguments[1] : l[0].files, p = a.fileManager.count(), f = t.isEmpty(l.attr("multiple")),
                    h = !c && f ? 1 : a.maxFileCount, m = a.maxTotalFileCount, g = m > 0 && m > h, v = f && p > 0,
                    w = function (t, i, r) {
                ...
                if (a.reader = null, a._resetUpload(), a._hideFileIcon(), a.dropZoneEnabled, c || (u = i.target && void 0 === i.target.files ? i.target.value ? [{name: i.target.value.replace(/^.+\\/, "")}] : [] : i.target.files || {}), r = u, t.isEmpty(r) || 0 === r.length) return c || a.clear(), void a._raise("fileselectnone");
            ...
            t._getThumbs().each(function () {
                var a = e(this), r = a.attr("data-fileindex"), s = a.attr("id");
                "-1" !== r && -1 !== r && (t._getThumbFile(a) ? a.attr({"data-fileindex": "-1"}) : (a.attr({"data-fileindex": i}), i++), t._getZoom(s).attr({"data-fileindex": a.attr("data-fileindex")}))
            })
            ...
            var i, a, r, s = e.name || "", n = e.type || "", o = (e.size || 0) / this.bytesToKB,
                l = this._parseFileType(n, s), d = this.allowedPreviewTypes, c = this.allowedPreviewMimeTypes,
                u = this.allowedPreviewExtensions || [], p = this.disabledPreviewTypes,
                f = this.disabledPreviewMimeTypes, h = this.disabledPreviewExtensions || [],
                m = this.maxFilePreviewSize && parseFloat(this.maxFilePreviewSize) || 0,
                g = new RegExp("\\.(" + u.join("|") + ")$", "i"), v = new RegExp("\\.(" + h.join("|") + ")$", "i");
            ...
            var a, r = this, s = r.reader, n = r.$previewContainer, o = r.$previewStatus, l = r.msgLoading,
                d = r.msgProgress, c = r.previewInitId, u = i.length, p = r.fileTypeSettings, f = r.allowedFileTypes,
                h = f ? f.length : 0, m = r.allowedFileExtensions, g = t.isEmpty(m) ? "" : m.join(", "),
                v = function (t, s, n, o, l) {
                    var d, c = e.extend(!0, {}, r._getOutData(null, {}, {}, i), {id: n, index: o, fileId: l}),
            ...
            r.fileManager.clearImages(), e.each(i, function (e, t) {
                ...
                r.lock(!0);
                var x, y, T, P, k, F, S, E, I, A, D, z = i[w], j = r._getFileId(z), U = c + "-" + j, $ = p.image,
                    M = r._getFileName(z, ""), R = (z && z.size || 0) / r.bytesToKB, B = "", O = t.createObjectURL(z),
                    L = 0, N = "", Z = !1, H = 0, W = function () {
                        var e = !!C.loadedImages[j], t = d.setTokens({index: w + 1, files: u, percent: 50, name: M});
                        setTimeout(function () {
                ...
                if (z) {
                    if (E = C.getId(z), h > 0) for (y = 0; y < h; y++) F = f[y], S = r.msgFileTypes[F] || F, N += 0 === y ? S : ", " + S;
                    if (!1 !== M) {
                        ...
                        D = $(z.type, M), o.html(l.replace("{index}", w + 1).replace("{files}", u)), n.addClass("file-thumb-loading"), r._initCapStatus("processing"), s.onerror = function (e) {
                            ...
                            var a, l, d, c, u, f, h, m = [];
                            if (l = {name: M, type: z.type}, e.each(p, function (e, t) {
                            ...
                            if (e.lengthComputable) {
                                ...
                                T = d.setTokens({index: w + 1, files: u, percent: i, name: M}), setTimeout(function () {
                                    Z || o.html(T)
                                }, r.processDelay)
                            }
            ...
            var e = this.fileManager, t = !1, i = this.resumableManager;
            ...
            var t = e.originalEvent, i = t.clipboardData && t.clipboardData.files || null;
            return i && this._dropFiles(e, i), this.$element
        }, pause: function () {
            var t, i = this, a = i.resumableManager, r = i.ajaxRequests, s = r.length, n = a.getProgress(),
                o = i.fileActionSettings, l = i.taskManager.getPool(a.id);
            if (!i.enableResumableUpload) return i.$element;
            if (l && l.cancel(), i._raise("fileuploadpaused", [i.fileManager, a]), s > 0) for (t = 0; t < s; t += 1) i.paused = !0, r[t].abort();
            return i.showPreview && i._getThumbs().each(function () {
                var t, a = e(this), r = i._getLayoutTemplate("stats"), s = a.find(".file-upload-indicator");
            ...
            var t, i = this, a = i.ajaxRequests, r = i.resumableManager, s = i.taskManager,
                n = r ? s.getPool(r.id) : void 0, o = a.length;
            if (i.enableResumableUpload && n ? (n.cancel().done(function () {
                i._setProgressCancelled()
            }), r.reset(), i._raise("fileuploadcancelled", [i.fileManager, r])) : i._raise("fileuploadcancelled", [i.fileManager]), i._initAjax(), o > 0) for (t = 0; t < o; t += 1) i.cancelling = !0, a[t].abort();
            return i._getThumbs().each(function () {
            ...
            var i, a, r = this, s = r.fileManager, n = s.count(), o = !e.isEmptyObject(r._getExtraData());
        ...
        if (t.hasFileAPISupport() || t.isIE(9)) {
            var r = Array.apply(null, arguments), s = [];
            switch (r.shift(), this.each(function () {
                var n, o = e(this), l = o.data("fileinput"), d = "object" == typeof a && a,
                    c = d.theme || o.data("theme"), u = {}, p = {},
    ...
    var a = "btn btn-sm btn-kv " + t.defaultButtonCss(), r = "btn " + t.defaultButtonCss(!0);
...
$("#multiplefileupload").fileinput(
    {
        ...
        dropZoneTitle: '<div class="upload-area"><i class="far fa-images"></i><p>Chọn hoặc thả file có đuôi .jpg, .png, .gif</p> <div> <button type="button">Chọn File</button> </div></div>',
        dropZoneClickTitle: "",
